...
We'll load the sentiment analysis pipeline using the `hf_load_pipeline` function, and we'll use the "distilbert-base-uncased-finetuned-sst-2-english" model which is a binary sentiment classifier. All huggingfaceR's functions begin with hf\_, handy when using RStudio's autofill features.
